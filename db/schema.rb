...
ActiveRecord::Schema.define(version: 2021_04_02_184354) do
  ...
  create_table "meeting_locations_users", id: false, force: :cascade do |t|
    ...
    t.index ["meeting_location_id", "user_id"], name: "meeting_location_index", unique: true
  end
  ...
  create_table "student_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "created_at"], name: "index_student_profiles_on_user_id_and_created_at"
  ...
  create_table "study_levels_users", id: false, force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.index ["study_level_id", "user_id"], name: "index_study_levels_users_on_study_level_id_and_user_id", unique: true
  end
  ...
  create_table "teacher_profiles", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_teacher_profiles_on_user_id_and_created_at"
